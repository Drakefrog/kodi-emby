...
| EmbyCon | faush01/plugin.video.embycon, `master` | `a56033d7e22ecb0d72e432ac5e20cf38d40f4a83` | upstream outer repository is retained at `sources/embycon`; addon is `plugin.video.embycon/`. Attribution remains in addon metadata; the upstream revision has no top-level license file. |
